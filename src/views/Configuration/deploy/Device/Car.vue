    ...
    <!-- 面包屑导航 -->
     <div class="nav">
      <el-breadcrumb separator="/">
        ...
        <el-breadcrumb-item class="weight">车载设备管理</el-breadcrumb-item>
      </el-breadcrumb>
    </div>
    <div class="main">
      <div class="left">
        ...
        <div class="company">
            <el-input v-model="input" placeholder="请搜索"></el-input>
              ...
              <ul v-for="(item,index) in componyList" :key="index">
                <el-radio-group v-model="radio" @change="getRadio">
                  ...
                  <li v-for="(li,index) in item.children" :key="index">
                    <div class="radioLine"></div>
                    <!--  @change="isSelect" -->
                    <el-checkbox :label="li.title" @change="isSelect(li.Id,li.title)" >{{li.title}}</el-checkbox>
                  </li>
                  </el-checkbox-group>
                </el-radio-group>
              </ul>
      ...
      <div class="right">
          ...
          <el-row>
             <el-col :span="8">
              <el-form-item label="审批人:">
                <el-input v-model="formInline.user" placeholder="审批人" style="width: 250px"></el-input>
              </el-form-item>
             </el-col>
             <el-col :span="8">
        ...
        <!-- 更多查询筛选 -->
        <el-form label-width="80px" v-show="more">
          <el-row>
             <el-col :span="8">
          ...
          <el-row>
             <el-col :span="12">
               <el-form-item label="上线日期:" label-width="80px">
                  <el-date-picker
             ...
             <el-col :span="12">
               <el-form-item label="维保到期日:" label-width="100px">
                  <el-date-picker
        ...
        <div class="operate">
          ...
          <el-button type="success" size="small">导出excel</el-button>
           ...
           <!-- 新建车载设备对话框 -->
        <el-dialog title="新建车载设备" :visible.sync="dialogFormVisible" width="40%">
          <el-form :inline="true" label-width="100px" :model="formCarList" ref="Form" label-position="left" :rules="rules">
            <div class="aside">
              ...
              <!-- 所属车辆 -->
              <el-form-item label="所属车辆:" prop="vehicle">
              ...
              <!-- 流量卡到期日期 -->
              <el-form-item  label="流量卡到期日期:" prop="maturity" class="maturity">
                <el-date-picker
          ...
          <div slot="footer" class="dialog-footer">
            ...
            <el-button type="primary" size="mini" @click="addDoneCar">确 定</el-button>
          </div>
        </el-dialog>

          <!-- 编辑车载设备对话框 -->
        <el-dialog title="编辑车载设备" :visible.sync="editDialogFormVisible" width="40%">
          <el-form :inline="true" label-width="100px" :model="editFormCarList" ref="editForm" label-position="left" :rules="editRules">
            <div class="aside">
              <!-- 所属单位 -->
              <el-form-item label="所属单位:" prop="unit">
        ...
        <el-table
          ...
          <el-table-column
           ...
           <el-table-column
            ...
            >
            <template>
              <el-button type="primary" plain round size="mini" icon="el-icon-edit" @click="showEditForm">编辑</el-button>
...
export default {
  data () {
    return {
      ...
      // 左侧公司列表数据
      componyList: [
        { id: 1, title: '西弗瑞', children: [ { title: '子公司1', Id: 1 }, { title: '子公司2', Id: 1 } ] },
        { id: 2, title: '西弗瑞2', children: [ { title: '子公司3', Id: 2 }, { title: '子公司4', Id: 2 } ] },
        { id: 3, title: '西弗瑞3', children: [ { title: '子公司5', Id: 3 }, { title: '子公司6', Id: 3 } ] }
      ]
    }
  },
  components: {
  ...
  methods: {
    ...
    isSelect (id, title) {
      ...
      if (this.radio === id) {
        ...
        console.log('不能选择')
        this.checkList = this.checkList.filter((item) => item !== title)
      }
    }
  }
}

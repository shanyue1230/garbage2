<template>
  <div class="samllstation">
    <!-- 面包屑导航 -->
     <div class="nav">
      <el-breadcrumb separator="/">
        <el-breadcrumb-item>基础信息</el-breadcrumb-item>
        <el-breadcrumb-item>环卫作业点管理</el-breadcrumb-item>
        <el-breadcrumb-item class="weight">小压站</el-breadcrumb-item>
      </el-breadcrumb>
    </div>
    <div class="body">
      <div class="left">
      ...
      <div class="right">
          ...
          <el-row>
             <el-col :span="8">
              <el-form-item label="搜 索：">
                <el-input v-model="formInline.user" placeholder="请输入小压站名称"  style="width: 250px"></el-input>
              </el-form-item>
             </el-col>
             <el-col :span="8">
        ...
        <!-- 行内表单+入职时间 -->
        <div class="entryTime">
          <el-form :inline="true" :model="formDate" class="demo-form-inline" label-width="120px">
        ...
        <div class="btn">
          ...
          <el-button type="primary">区域设置</el-button>
